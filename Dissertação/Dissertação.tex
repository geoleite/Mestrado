...
\end{figure}
 ...
 \citeonline{gerla2012vehicular} introduziu um novo modelo computacional, a computação veicular em nuvem  (VCC). O VCC é uma variação da computação em nuvem móvel (MCC), que começa a partir de um modelo convencional de computação em nuvem. Sendo que a maioria das consultas são sobre o moundo que nos rodeia, ou seja possui relevância local, e os veículos são os melhores exemplos deste ambiente.
...
Conforme dito anteriormente, foram definidos 36 cenários de testes, sendo 32 levando em consideração quantidades de veículos, largura de banda da comunicação e a criptografia ou não dos dados e 4 utilizando a velocidade total disponível com e sem criptografia dos dados. Os detalhes da para cada cenário está apresentado a seguir:

\begin{enumerate*}
	\item{\textbf{Experimento 1}: rodando o teste com 50  veículos sem a utilização da criptografia e foram utilzadas duas máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 2}: rodando o teste com 50  veículos com o uso da criptografia e  foram utilzadas duas máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 3}: rodando o teste com 100  veículos sem o uso da criptografia e foram utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 4}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 5}: rodando o teste com 200  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 6}: rodando o teste com 200  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 7}: rodando o teste com 400  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 8}: rodando o teste com 500  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 9}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 10}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 11}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 12}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 13}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 14}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 15}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 16}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 17}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 18}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 19}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 20}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 21}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 22}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 23}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 24}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 25}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 26}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 27}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 28}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 29}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 30}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 31}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 32}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 33}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 34}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 35}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas;}
	\item{\textbf{Experimento 36}: rodando o teste com 100  veículos com o uso da criptografia, sendo utilzadas quatro máquinas físicas com windows rodando 25 \textit{hosts} cada uma delas.}
\end{enumerate*}
