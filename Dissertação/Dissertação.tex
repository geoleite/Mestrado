...
Ainda segundo \citeonline{nasim2012distributed}, o ITS possui subsistemas e tem como objetivo atuar de forma direcionada e específica sobre subáeas do gerenciamento de transporte, buscando garantir a eficiência e qualidade da mobilidade urbana e são subdivididos em seis áreas de gestão são elas: 
...
%De acordo com experimento, a plataforma porposta apresentou resultados eficientes para as velocidades 3G, 4G e 5G, apresentando resultados satisfatórios, como mostrado na Figura \ref{fig:graficotempomedio}.
...
%O Sistema Avançado de Gestão de Tráfego (ATMS) pode utilizar a plataforma I9VANET
...
%Para avaliar a flexibilidade, pode abordar que sua proposta é facilmente reconfigurável e adaptável a diferentes cenários. Ou seja, as modificações são bem dinâmicas e de fácil aplicação.
